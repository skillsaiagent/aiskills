...
视觉质量诊断助手用于回答「这张图够发布吗」、电商运营、Amazon、增长诊断，适合销售、运营、市场营销、电商在明确业务目标、内容材料或分析对象后调用。
它会结合视觉 brief 或截图说明、粘贴视觉 brief、截图说明、品牌规范、页面问题、平台规格或修改…等输入，整理关键上下文，并输出视觉/创意诊断、提示词或分镜方案、发布规格检查，便于继续执行、复盘或交付。
能力定位补充：skills.sh all-time/trending 信号显示 image 有用户需求；平台展示为 design_media 业务助手目录，输出可复核诊断、建议或生产准备包。
