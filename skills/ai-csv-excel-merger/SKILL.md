---
name: ai-csv-excel-merger
description: "资料整理助手适合运营、产品、销售、software在用户提出“这份材料重点是什么”这类问题，需要快速拆解目标、判断重点并形成可执行结果时使用，帮助基于输入材料生成合并方案、字段冲突清单、处理结果说明。"
requiredEnvVars:
  - name: AISKILLS_API_KEY
    description: "从 AI Skills 官网 https://ai-skills.ai 获取API Key，用于运行时技能调用。"
---

# ai-csv-excel-merger 资料整理助手
...
资料整理助手用于回答「这份材料重点是什么」、资料整理、数据清理、行动项，适合运营、产品、销售、software在明确业务目标、内容材料或分析对象后调用。
它会结合文档、表格或记录、粘贴文档、表格、会议记录、客户反馈、评论文本或待整理资料。等输入，整理关键上下文，并输出合并方案、字段冲突清单、处理结果说明，便于继续执行、复盘或交付。
能力定位补充：表格处理是高频办公任务，适合以 artifact 交付。
...
- 合并方案、字段冲突清单、处理结果说明：围绕用户目标整理可直接阅读、复盘或交付的核心结果。
...
- 再检查结果是否覆盖合并方案、字段冲突清单、处理结果说明，以及是否给出明确下一步动作。
