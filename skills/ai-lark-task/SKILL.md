...
它会结合飞书任务记录、粘贴任务标题、描述、评论、负责人、截止时间、状态变化或导出的任务清…等输入，整理关键上下文，并输出摘要、诊断结论、行动建议和可复用交付物，便于继续执行、复盘或交付。
...
- 输入材料解读：结合推进目标（例如清理逾期任务、明确责任人、准备周会或形成交接清单。）、接收团队（例如项目负责人、执行成员、管理者、客户成功团队或外部协作方。）、任务链接说明（填写飞书任务或项目链接，并补充链接中可见的任务摘要；系统不会自动打开链接。）提炼关键上下文和判断依据。
