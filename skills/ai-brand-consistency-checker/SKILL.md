---
name: ai-brand-consistency-checker
description: "品牌一致性诊断助手适合内容创作者、市场营销、运营、内容媒体在用户提出“品牌表达统一吗”这类问题，需要快速拆解目标、判断重点并形成可执行结果时使用，帮助基于输入材料生成调性偏差、改写建议、一致性清单。"
requiredEnvVars:
  - name: AISKILLS_API_KEY
    description: "从 AI Skills 官网 https://ai-skills.ai 获取API Key，用于运行时技能调用。"
---

# ai-brand-consistency-checker 品牌一致性诊断助手
...
品牌一致性诊断助手用于回答「品牌表达统一吗」、内容生产、文案优化、发布准备，适合内容创作者、市场营销、运营、内容媒体在明确业务目标、内容材料或分析对象后调用。
它会结合视觉 brief 或截图说明、粘贴视觉 brief、截图说明、品牌规范、页面问题、平台规格或修改…等输入，整理关键上下文，并输出调性偏差、改写建议、一致性清单，便于继续执行、复盘或交付。
能力定位补充：品牌一致性审查适合公开业务用户提交物料使用。
...
- 调性偏差、改写建议、一致性清单：围绕用户目标整理可直接阅读、复盘或交付的核心结果。
...
- 先判断输出是否回答了用户关于「品牌一致性诊断助手」的核心问题。
- 再检查结果是否覆盖调性偏差、改写建议、一致性清单，以及是否给出明确下一步动作。
