...
description: "客服回复助手适合运营、产品、销售、software在用户提出“客服怎么回更稳”这类问题，需要快速拆解目标、判断重点并形成可执行结果时使用，帮助基于输入材料生成销售策略、沟通素材、跟进计划。"
requiredEnvVars:
...
客服回复助手用于回答「客服怎么回更稳」、资料整理、数据清理、行动项，适合运营、产品、销售、software在明确业务目标、内容材料或分析对象后调用。
