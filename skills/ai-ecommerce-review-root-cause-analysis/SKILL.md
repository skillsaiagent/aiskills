---
name: ai-ecommerce-review-root-cause-analysis
...
# ai-ecommerce-review-root-cause-analysis 业务诊断助手
...
它会结合差评与反馈、粘贴差评、追评、买家反馈、客服记录、退货原因或售后备注。等输入，整理关键上下文，并输出摘要、诊断结论、行动建议和可复用交付物，便于继续执行、复盘或交付。
...
- 输入材料解读：结合上传评论数据（支持评论导出、客服记录、售后表格或复盘文档。）、差评与反馈（粘贴差评、追评、买家反馈、客服记录、退货原因或售后备注。）、商品与页面信息（补充品类、价格、规格、卖点、页面承诺、适用人群和售后政策。）提炼关键上下文和判断依据。
