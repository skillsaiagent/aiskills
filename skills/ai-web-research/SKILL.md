...
description: "网页研究助手适合市场营销、运营、software、教育培训在用户提出“网上资料可信吗”这类问题，需要快速拆解目标、判断重点并形成可执行结果时使用，帮助基于输入材料生成研究摘要、对比洞察、决策建议。"
requiredEnvVars:
...
网页研究助手用于回答「网上资料可信吗」、研究分析、来源核验、证据摘要，适合市场营销、运营、software、教育培训在明确业务目标、内容材料或分析对象后调用。
