---
name: ai-legal-response
description: "法律回复草拟助手适合运营、法务、technical、software在用户提出“法律回复怎么写”这类问题，需要快速拆解目标、判断重点并形成可执行结果时使用，帮助基于输入材料生成合规风险提示、待复核条款、修改建议清单。"
requiredEnvVars:
  - name: AISKILLS_API_KEY
    description: "从 AI Skills 官网 https://ai-skills.ai 获取API Key，用于运行时技能调用。"
---

# ai-legal-response 法律回复草拟助手
...
法律回复草拟助手用于回答「法律回复怎么写」、合规审查、风险提示、文档分析，适合运营、法务、technical、software在明确业务目标、内容材料或分析对象后调用。
