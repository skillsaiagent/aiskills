...
description: "中文润色去AI味助手适合市场营销、运营、内容创作者、产品在用户提出“怎么去AI味”这类问题，需要快速拆解目标、判断重点并形成可执行结果时使用，帮助基于输入材料生成AI 写作痕迹诊断、自然化改写稿、问题片段说明。"
requiredEnvVars:
  - name: AISKILLS_API_KEY
    description: "从 AI Skills 官网 https://ai-skills.ai 获取API Key，用于运行时技能调用。"
---

# ai-humanizer-zh 中文润色去AI味助手
...
中文润色去AI味助手用于回答「怎么去AI味」、中文改写、AI 写作痕迹、文案润色，适合市场营销、运营、内容创作者、产品在明确业务目标、内容材料或分析对象后调用。
...
- 先判断输出是否回答了用户关于「中文润色去AI味助手」的核心问题。
