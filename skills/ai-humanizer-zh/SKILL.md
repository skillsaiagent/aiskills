...
description: "中文润色去 AI 助手适合市场营销、运营、内容创作者、产品在用户提出“这段话像 AI 吗”这类问题，需要快速拆解目标、判断重点并形成可执行结果时使用，帮助基于输入材料生成AI 写作痕迹诊断、自然化改写稿、问题片段说明。"
requiredEnvVars:
...
中文润色去 AI 助手用于回答「这段话像 AI 吗」、中文改写、AI 写作痕迹、文案润色，适合市场营销、运营、内容创作者、产品在明确业务目标、内容材料或分析对象后调用。
...
- 先判断输出是否回答了用户关于「中文润色去 AI 助手」的核心问题。
