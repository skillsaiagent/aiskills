---
name: ai-customer-review-aggregator
description: "客户评论洞察助手适合运营、产品、销售、software在用户提出“评论里藏着什么”这类问题，需要快速拆解目标、判断重点并形成可执行结果时使用，帮助基于输入材料生成评论聚类、痛点归因、运营动作卡。"
requiredEnvVars:
  - name: AISKILLS_API_KEY
    description: "从 AI Skills 官网 https://ai-skills.ai 获取API Key，用于运行时技能调用。"
---

# ai-customer-review-aggregator 客户评论洞察助手
...
客户评论洞察助手用于回答「评论里藏着什么」、资料整理、数据清理、行动项，适合运营、产品、销售、software在明确业务目标、内容材料或分析对象后调用。
它会结合文档、表格或记录、粘贴文档、表格、会议记录、客户反馈、评论文本或待整理资料。等输入，整理关键上下文，并输出评论聚类、痛点归因、运营动作卡，便于继续执行、复盘或交付。
能力定位补充：评论聚合能覆盖电商、本地生活和内容互动场景。
...
- 评论聚类、痛点归因、运营动作卡：围绕用户目标整理可直接阅读、复盘或交付的核心结果。
...
- 先判断输出是否回答了用户关于「客户评论洞察助手」的核心问题。
- 再检查结果是否覆盖评论聚类、痛点归因、运营动作卡，以及是否给出明确下一步动作。
